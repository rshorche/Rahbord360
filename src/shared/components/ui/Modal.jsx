...
const Modal = ({ isOpen, onClose, title, children, className }) => {
  ...
  return (
    <div
      ...
      <div
        className={cn(
          "bg-white rounded-xl shadow-2xl w-full max-w-lg mx-auto flex flex-col transform transition-all animate-scale-in",
          "focus:outline-none",
          className
        )}
        ...
        <div className="flex-shrink-0 flex justify-between items-center p-4 sm:p-5 border-b border-content-200">
          <h3
            id="modal-title"
            className="text-lg font-semibold text-content-main">
            {title}
          </h3>
          <button
            onClick={onClose}
